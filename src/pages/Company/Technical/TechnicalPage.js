      ...
      pricingDetails: [
        {
          ...
          pricingInnerText:
            "Access to the full range of construction and engineering services.Technical services are all Project managed by our experienced team.",
        },

        {
          ...
          pricingInnerIcon: "mdi mdi-check-bold bg-soft-success me-2",
          pricingInnerText:
            "Pacific Manpower has completed many extensive engineering and construction projects  at Ok TediTedi , Lihir, Simberi, Pom, and throughout PNG. ",
        },
        {
          id: 4,
          pricingInnerClassName: "pricing-item",
          pricingInnerIcon: "mdi mdi-check-bold bg-soft-success me-2",
          pricingInnerText:
            "Maintenance, Shutdowns, New projects, and Tax credit projects.PMP have specialized project operations at a number of mine sites and also the Napanapa refinery.",
        },

        {
          ...
          pricingInnerIcon: "mdi mdi-check-bold bg-soft-success me-2",
          pricingInnerText:
            "Specific technical skills available.Solid track record in Projects throughout the country.Project Management, Fixed price Projects,  Labour and Supervision supplyPacific Manpower offers the total solution.",
        },
      ],
    },
  ];
