...
import blogImage3 from "../../../assets/images/elementsaboutus1.jpg";



const images = [blogImage1, blogImage3, blogImage3];
        ...
        <section className="section overflow-hidden">
          <Container>
            <Row className="align-items-center g-0">
              <Col lg={6} className="about" style={{ marginTop: "0em", marginBottom: "17em" }}>
