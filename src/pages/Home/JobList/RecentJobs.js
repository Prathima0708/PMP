...
import { Col, Row, Modal, ModalBody, Input, Label, Button } from "reactstrap";
...
const RecentJobs = () => {
  ...
  return (
    <React.Fragment>
      {recentJobs.map((recentJobDetails, key) => (
        <div
              ...
              <Col md={2}>
                <div className="text-center mb-4 mb-md-0">
                  <Link to="/company-details">
                    <img
                      src={recentJobDetails.company_image}
                      alt=""
                ...
                <div className="mb-2 mb-md-0">
                  <h5 className="fs-18 mb-1">
                    <Link to="/jobdetails" className="text-dark">
                      {recentJobDetails.job_title}
                    </Link>
                  </h5>
                  <p className="text-muted fs-14 mb-0">
                    {recentJobDetails.company_id.company_name}
                  </p>
                </div>
              </Col>
              ...
              <Col md={3}>
                <div className="d-flex mb-2">
                  ...
                  <p className="text-muted mb-0">
                    {recentJobDetails.job_location_id.country}
                  </p>
                </div>
              </Col>
            ...
            <Row>
                ...
                <div>
                  <p className="text-muted mb-0">
                    <span className="text-dark">
                      {recentJobDetails.job_description === null
                        ? ""
                        : "Job Description :"}
                    </span>
                    {recentJobDetails.job_description}{" "}
                  </p>
                </div>
              </Col>
              ...
              <Col lg={2} md={3}>
                <div className="text-start text-md-end">
                  <Button
                    onClick={() => navigateHandler(recentJobDetails.id)}
