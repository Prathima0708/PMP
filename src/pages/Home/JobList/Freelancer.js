...
const Freelancer = () => {
  ...
  useEffect(() => {
    axios
      .get(`${subURL}/filteredjobbyfreelancer/freelancer/`)
      .then((response) => {
              ...
              <Col md={2}>
                <div>
                  <p className="text-muted mb-2">
                    Salary:{freelancerJobdetails.salary}
                  </p>
                </div>
              </Col>
              ...
              <Modal isOpen={modal} toggle={openModal} centered>
                <ModalBody className="modal-body p-5">
                  ...
                  <div className="d-flex justify-content-between ml-3 ">
                    <button
                      onClick={() => applyforJob(freelancerJobdetails.id)}
                    ...
                    <button
                      onClick={() => navigateHandler(freelancerJobdetails.id)}
