...
import backgrounImage from "../../../assets/newimages/aboutus.jpeg";
...
const Section = () => {
  ...
  style={{
   ...
   // background: "linear-gradient(rgba(170, 210, 226, 0.8), rgba(255, 255, 166, 0.8))",
    ...
    <Row className="justify-content-center mt-4">
      <Col md={6} className="mt-4">
        <div className="text-center text-black">
          <h3 className="mb-4" style={{fontSize:'45px'}}>About Us</h3>
          <div className="page-next">
            <nav className="d-inline-block" aria-label="breadcrumb text-center">
              <ol className="breadcrumb justify-content-center">
                ...
                <li className="breadcrumb-item active text-black" aria-current="page" style={{fontSize:'15px',marginBottom:'1em'}}>
                  {" "}
                  About Us{" "}
                </li>
                <li className="breadcrumb-item active text-black" aria-current="page" style={{fontSize:'15px',marginBottom:'1em'}}>
